# Go-Gateway：高性能 API 网关

> 基于 Go 语言实现的高性能、可观测、易量化测试的 API 网关
>
> **技术栈**：Go 1.25 · Radix Tree · Token Bucket · Circuit Breaker · Goroutine Pool · Prometheus
...
│  ┌──────────┐  ┌──────────┐  ┌──────────┐  ┌────────────────┐  │
│  │ 指标收集  │→│  限流控制 │→│  熔断保护 │→│  路由匹配       │  │
│  │(Metrics) │  │(RateLimit)│  │(Circuit  │  │ (Radix Tree)  │  │
│  └──────────┘  └──────────┘  │ Breaker) │  └───────┬────────┘  │
│                              └──────────┘          │           │
│                                              ┌─────▼──────┐    │
│                                              │ 负载均衡    │    │
...
> 📖 详细测试指南：[benchmark/QUANTITATIVE_TEST_GUIDE.md](./benchmark/QUANTITATIVE_TEST_GUIDE.md)
...
- [量化测试手册](./benchmark/QUANTITATIVE_TEST_GUIDE.md)
- [JMeter 测试计划](./benchmark/Gateway_QuantitativeTest.jmx)
